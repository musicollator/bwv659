...
alt = {
   \new Voice \relative d' {
      ...
      a8 r r b c r r a
      b!4 r8 b a4 r8 a
      g4 r16 f g f g8 r r16 d es d
      es8 r r es d fis g a
      d,8 g r d~ d c16 h c( d) d( es!)
      %% Takt 25 ==================================================
...
tenor = {
   \new Voice \relative g {
      ...
      c8 b!16 c d4 r8 g, a r
      r8 b c a b d16 c d8 f
      ...
      f'8 r r f g f es4
      r8 d g f es d r d
      d4 r16 d es d c8 r r16 h c h
      c8 r r c16 b! a!8 c d16( c) c( b)
      b8 g~ g fis g2~
      %% Takt 25 ==================================================
...
sopranmidi = {
   \new Voice \relative g' {
      ...
      g16 fis e d \times 2/3 { g32 fis g~ } g8.~ g32 a g fis! g c a16 g8 \times 4/5 { fis64 g fis g fis~ } fis32 g32
      g16 g' f!8~ f16 es!32 d g f es d f es d c b'!8~ b32 a b c b a g a
      g32 fis g a a16~ a64 c,32.~ c32 es d c d c b a b16 g'32 es cis d g,16 \times 2/3 { g32 a b~ } b16 b128 a b a g32 a16
      g1
   }
}
